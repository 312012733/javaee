...
// extends ArrayList<T>
{
    ...
    public Page(List<T> pageList, Long maxCount, Integer curPage, Integer pageSize)
    {
    ...
    public static <T> Page<T> buildPage(com.github.pagehelper.Page<T> page)
    {
        return new Page<>(page.getResult(), page.getTotal(), page.getPageNum() - 1, page.getPageSize());
    }
