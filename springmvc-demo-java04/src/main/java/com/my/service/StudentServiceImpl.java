...
import com.my.advice.LoggerOptType;
import com.my.advice.LoggerType;
import com.my.advice.SystemLogger;
...
public class StudentServiceImpl implements IStudentService
{
    ...
    @SystemLogger(desc = "添加 名字是 #{stuDto.name}的学生，他的id为 #{stuDto.id}", operation = LoggerOptType.SAVE, type = LoggerType.USER)
    @Transactional
    @Override
