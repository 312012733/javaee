...
//    public Page<Student> findStudentByPage2(Page<Student> page, StudentDTO condition)
//    {
...
//    }
    ...
    @Override
    public Page<Student> findStudentByPage(Page<Student> page, StudentDTO stuCondition)
    {
        ...
        page.setPageList(studentList);
        
        return page;
    }
    
    private List<Student> findStudentList(Page<Student> page, StudentDTO stuCondition)
    {
    ...
    private Long findMaxCount(StudentDTO stuCondition)
    {
        Session session = sessionFactory.getCurrentSession();
        CriteriaBuilder criteriaBuilder = session.getCriteriaBuilder();
    ...
    private Predicate toPredicate(StudentDTO stuCondition, CriteriaBuilder criteriaBuilder, Root<Student> root)
    {
